    ...
    <div>
      ...
      <div className="modal text text-neutral-focus">
        <div className="modal-box base-300">
          <h3 className="font-bold text-lg">TODO: These are your gifts that you sent!!!</h3>
          <p className="py-4">
         TODO   You've been selected for a chance to get one year of subscription to use Wikipedia for free!
          </p>
